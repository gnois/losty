...
local cmd_new = function(opts)
  ...
  lauzy workflow:
	 - After editing .lau files, compile before restart:
		luajit /path/to/lau.zy -f -d ngx app.lau app.lua
		luajit /path/to/lau.zy -f -d ngx views/home.lau views/home.lua
		luajit /path/to/lau.zy -f -d ngx views/auth.lau views/auth.lua
		luajit /path/to/lau.zy -f -d ngx views/protected.lau views/protected.lua
]=]
    print(string.format([=[
Done!
